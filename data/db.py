...
@db
async def get_mg(meg_id: str, conn: Connection):
...
async def insert_single3(msg_id: int, reply_id: int, msg: Message, conn: Connection, meg_id: str = None,
    ...
    if len(msg.photo) != 0:
        ...
        file_type = None
        file_id = None
    await insert_single(msg_id, conn, meg_id, reply_id, file_type, file_id, lang_key, post_id,
                        msg.has_media_spoiler or False)
